...
export default {
  ...
  data() {
    return {
      itemsPerPageArray: [4, 8, 12, 16, 24],
      search: '',
      filter: {},
      sortDesc: false,
      page: 1,
      ...
      items: this.$store.state.company,
     }
  },
  computed: {
    numberOfPages() {
  ...
  components: {
    "upload-account": require('@/components/company/UploadFileAccount.vue').default,
    "card-actions": require('@/components/Shared/CardActions.vue').default,
  },
